...
from .othernodes import state_printer, final_output_response, categorize_question,contextualise_question
...
class GraphState(TypedDict):
    ...
    question_category: str
    draft_response: str
    draft_response_stream: object
    final_response: str
    final_response_stream: object
    final_answer: str
    final_answer_stream: object
    research_info_rag: List[str]  # this will now be the RAG results
    research_info_web: List[str]  # this will now be the web results
    info_needed: bool
    # num_steps : int
...
# workflow.add_node("contextualise_question", contextualise_question)
# workflow.add_node("categorize_question", categorize_question)
# workflow.add_node("research_info_search_rag",
#                   research_info_search_rag)  # rag search
# workflow.add_node("research_info_search_web",
#                   research_info_search_web)  # web search
# workflow.add_node("state_printer", state_printer)
# workflow.add_node("draft_response_writer", draft_response_writer)
# workflow.add_node("analyze_draft_response", analyze_draft_response)
# workflow.add_node("rewrite_response", rewrite_response)
...
# # workflow.set_entry_point("categorize_question")
# workflow.set_entry_point("contextualise_question")
# workflow.add_edge("contextualise_question", "categorize_question")
